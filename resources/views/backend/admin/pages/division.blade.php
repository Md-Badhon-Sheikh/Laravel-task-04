...
<div class="page-content">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h3 class="text-center mb-2">Division</h3>
                    ...
                    <div class="table-responsive" id="print_data">
                        <table id="dataTableExample" class="table tableSmall" style="width: 100%;">
                            ...
                            <tbody>
                               @foreach($data['division_list'] as $key => $single_division)
                                <tr>
                                    <td>{{ $key + 1 }}</td>


                                    <td>
                                      {{$single_division->name_en}}

                                    </td>
                                    <td>
                                      {{$single_division->name_bn}}

                                    </td>
                                    <td>
                                        {{ $single_division->priority}}

                                    </td>
                                    <td>
                                        <a data-bs-toggle="modal" data-bs-target="#EditDivision"
                                            data-id="{{$single_division->id}}"
                                            data-name_en="{{$single_division->name_en}}"
                                            data-name_bn="{{$single_division->name_bn}}"
                                            data-priority="{{$single_division->priority}}"
                                            class="edit btn btn-success btn-icon"><i class="fa-solid fa-edit"></i></a>

                                        <a class="btn btn-danger btn-icon" data-delete="{{$single_division->id}}"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('admin.division')}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
